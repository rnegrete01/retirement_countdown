...
```Essentially, all this button does is enter data. This was primarily coded into the program so that the software developer didn't have to enter test data over and over again for testing purposes.```
